...
Tracing algorithms on concrete examples is fundamental to how teachers explain and how
students learn an algorithm's behavior. On both blackboards and paper, they draw an
...
The system's direct manipulation (DM) gesture set enables the user to demonstrate the algorithm as a
...
\pg{add one sentence for results}
