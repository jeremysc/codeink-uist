...
people typically draw an example data structure and a storyboard of how it is transformed by
the algorithm. But hand drawing is tedious and limiting
because data structures can be only erased and redrawn, and the
...
user to directly manipulate data structures and record the trace as a
set of interactive, sharable program steps.
