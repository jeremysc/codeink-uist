...
it is unclear whether the parent object should be altered. For
example, when dragging an element away from a list, should a copy of the
element be made, or should the element be removed from the list?
...
possible mutation behaviors if the user dwells for more than one second.
%%% we keep explaining ``dwell’’; once is enough.
